...
# main config
PLUGINSLUG='rest-filter-response-fields'
CURRENTDIR=`pwd` # returns basename of current directory
MAINFILE="rest-filter-response-fields.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="adamsilverstein" # your svn username
